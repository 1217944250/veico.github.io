    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-office-building"> 项目信息管理</i>
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            ...
            >
                ...
                <el-table-column prop="ptype" label="项目类别" align="center"></el-table-column>
                <el-table-column prop="mprice" label="模型价格" align="center"></el-table-column>
                <el-table-column prop="xprice" label="渲染价格" align="center"></el-table-column>
                <el-table-column prop="hprice" label="后期价格" align="center"></el-table-column>
                <el-table-column prop="pbt" label="项目开始时间" align="center"></el-table-column>
                <el-table-column prop="pet" label="项目结束时间" align="center"></el-table-column>
    ...
    export default {
        ...
        methods: {
            getTableData: function () {
                let that = this;
                this.$axios.get('api/project/query')
